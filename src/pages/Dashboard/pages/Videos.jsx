...
import UpsertVideo from "../components/modal/UpsertVideo";
...
const Videos = () => {
  ...
  const handleDelete = (id) => {
    ...
    setConfirmation({
      data: id,
      popupType: "deleteVideo",
      popupMessage: "Are you sure you want to delete this video?",
    });
  };
  ...
  if (!isLoading && !isError && videos?.length === 0) {
    content = <ErrorMessage message={"No video found"} />;
  }

  if (!isLoading && !isError && videos?.length > 0) {
    content = <Table headers={headers} rowData={videos} />;
  }
